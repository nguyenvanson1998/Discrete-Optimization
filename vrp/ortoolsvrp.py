...
def routing(customers, depot, customer_count, vehicle_count, vehicle_capacity,times):
...
if __name__ == '__main__':
	...
	depot = customers[0] 
	routing(customers, depot, customer_count, vehicle_count, vehicle_capacity,10)